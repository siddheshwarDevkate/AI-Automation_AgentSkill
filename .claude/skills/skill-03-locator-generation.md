...
Load the Knowledge files listed for Skill 03 in .claude/agent/agent.md's **Skill Dependency Matrix** — that table is the single source of truth and is deliberately not restated here. This Skill uses no Template.
...
## Locator Selection Strategy (per .claude/skills/knowledge/locator-strategy.md)
