...
## Purpose
Playwright-specific best practices for generated automation code. Focuses only on Playwright APIs and recommended usage — refer alongside .claude/skills/knowledge/framework-rules.md, .claude/skills/knowledge/framework-architecture.md, and .claude/skills/knowledge/locator-strategy.md.
...
- **BP-103 — Locator Selection.** Which locator strategy to use for a given element (priority order, validation, special cases) is owned by .claude/skills/knowledge/locator-strategy.md — follow it exactly rather than choosing an ad hoc order here.
